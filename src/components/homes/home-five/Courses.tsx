...
const Courses = () => {
  ...
  return (
    <section
      className="courses-area-four courses__bg-three"
      style={{ backgroundImage: `url(/assets/img/bg/h5_courses_bg.jpg)` }}
    >
      <div className="courses__bg-shape-one">
        <InjectableSvg
          src="/assets/img/courses/h5_courses_bg_shape01.svg"
          alt=""
      ...
      <div className="courses__bg-shape-two">
        <InjectableSvg
          src="/assets/img/courses/h5_courses_bg_shape02.svg"
          alt=""
          className="injectable"
        />
      </div>
          ...
          <div className="col-xl-5 col-lg-8">
            <div className="section__title text-center mb-50">
              ...
              <h2 className="title bold">
                Get The Best Exciting Class Experience With us
              </h2>
            </div>
          </div>
        </div>
                ...
                <div className="courses__item-six shine__animate-item">
                  <div className="courses__item-thumb-five shine__animate-link">
                    ...
                    <a
                      ...
                      className="courses__wishlist-two course-heart-btn"
